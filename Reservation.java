...
public class Reservation {
    ...
    public Reservation(int id, String name, String date, int numberOfArrivals) {
        this.id = id;
        this.name = name;
        this.date = date;
...
class ReservationSystem{
    ...
    int nextId=1;
    public Reservation makeReservation(String name, String date, int numberOfArrivals) {
        Reservation reservation = new Reservation(nextId++, name, date, numberOfArrivals);
...
class ReservationSystemLogin {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    for (Reservation r : reservationSystem.getReservations()) {
                        System.out.println(r.getId() + " - " + r.getName() + " - " + r.getDate() + " - " + r.getnumberOfArrivals());
                    }
                    break;
                case 3:
    ...
    {
        ReservationSystemLogin obj = new ReservationSystemLogin();
        obj.start();
    }
}
